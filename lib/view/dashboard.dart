...
import 'package:live_crypto_trends/view/twitter_feed.dart';
      ...
      child: StreamBuilder<ably.ConnectionStateChange>(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            //display prices charts inside SingleChildScrollView that creates a column for each child i.e. coin
...
class _CoinGraphItemState extends State<CoinGraphItem> {
  ...
  void _navigateToTwitterFeed(String hashtag) {
    ...
    Fimber.d("hashtag received: $hashtag");
  }
                ...
                children: [
                  Row(
                    ...
                    children: [
                      FlatButton(
                        onPressed: () => {
                          _navigateToTwitterFeed(coinName),
                          Fimber.d("coinName to pass: $coinName"),
                        },
